...
import { Eye, EyeOff, Home, User, Mail, Phone, Lock, MapPin, AlertCircle, CheckCircle } from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="p-6 sm:p-8 md:p-10">
                ...
                <h2 className="text-3xl font-bold text-gray-800 mb-2">
                  {isLogin ? "Welcome back!" : "List Your Property"}
                </h2>
                <p className="text-gray-600 mb-8">
                  {isLogin ? "Sign in to manage your properties" : "Create your landlord account"}
                </p>
              ...
              <div className="h-full flex flex-col justify-center px-4 sm:px-6 lg:px-8">
                <div className="space-y-10">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    >
                      Join thousands of landlords who are growing their rental business with our platform. 
                      Get access to quality tenants, streamlined management tools, and premium features.
                    </motion.p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {[
                        {
                          title: "Wide Tenant Reach",
                          description: "Connect with thousands of verified tenants actively looking for properties.",
                          icon: "👥"
                        },
                        {
                          title: "Easy Management",
                          description: "Manage all your properties and bookings from one dashboard.",
                          icon: "📊"
                        },
                        {
                        ...
                        },
                        {
                          ...
                          description: "Dedicated support team to help you maximize your listings.",
                          icon: "🛎️"
                        }
                      ].map((benefit, index) => (
                        <motion.div
